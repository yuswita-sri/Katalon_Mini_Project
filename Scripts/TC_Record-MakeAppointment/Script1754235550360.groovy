...
WebUI.selectOptionByValue(findTestObject('Object Repository/Record - CURA Healthcare Service/dropdown_Tokyo CURA Healthcare Center'), 
    'Seoul CURA Healthcare Center', true)

WebUI.click(findTestObject('Object Repository/Record - CURA Healthcare Service/visit date'))

WebUI.click(findTestObject('Object Repository/Record - CURA Healthcare Service/td_28'))

WebUI.click(findTestObject('Object Repository/Record - CURA Healthcare Service/button_Book Appointment'))
